...
export class SmashcordHubService {
  public readonly characters: Discord[] = [
    ...
    new Discord(
      ...
      ['Clipho', 'Miden', 'Feyuu', 'Kekepi', 'Nahé', 'Laggron'],
      [],
      'aNm6hmkwjV'
    ),
    new Discord(
  ...
  public readonly local: Discord[] = [
    new Discord(
      ...
      [],
      ['Bruxelles', 'Gand', 'Bruges', 'Anvers', 'Liège', 'Charleroi'],
      'SWxWtZx'
    ),
    new Discord(
      ...
      [],
      ['BFC', 'Dijon', 'Besançon', 'Beaune', 'Autun', 'Nevers'],
      '6JSSzvA'
    ),
    new Discord(
      'Bretagne',
      ...
      [],
      ['Rennes', 'Saint-Malo', 'Quimper', 'Vannes', 'Dinan'],
      'ZWp9tW9'
    ),
    new Discord(
      'Corse',
      ...
      [],
      ['Ajaccio', 'Bastia', 'Bonifacio', 'Calvi'],
      'DqdYNud'
    ),
    new Discord(
      'Grand-Est',
      ...
      [],
      ['Strasbourg', 'Colmar', 'Reims', 'Metz', 'Mulhouse', 'Troyes', 'Nancy', 'Verdun'],
      'F45w43p'
    ),
    new Discord(
      'Ile-de-France',
      ...
      [],
      ['Paris', 'Meaux', 'Versaille', 'Vincennes', 'Fontainebleau', 'Melun', 'Montreuil', 'Nanterre', 'Noisy-le-Grand'],
      'uqmpRnX'
    ),
    new Discord(
      'Normandie',
      ...
      [],
      ['Rouen', 'Le Havre', 'Caen', 'Deauville', 'Bayeux', 'Honfleur'],
      'vwzWMPj'
    ),
    new Discord(
      'Nouvelle-Aquitaine',
    ...
    new Discord(
      ...
      [],
      ['Amiens', 'Beauvais', 'Compiègne', 'Laon', 'Chantilly', 'Senlis', 'Saint-Quentin'],
      'RTRtnnh'
    ),
    new Discord(
      'Réunion',
      ...
      [],
      ['Saint-Denis', 'Cilaos', 'Salazie', 'Saint-Leu', 'Saint-Joseph'],
      '3gc7u27'
    ),
  ];
